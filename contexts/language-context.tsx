...
const translations = {
  ja: {
    ...
    "cardback.lydia30.name": "30日連続ログインボーナス",
    "cardback.lydia30.description": "30日連続ログインで授かる特別なカードバック",
    "cardback.lydia60.name": "60日連続ログインボーナス",
